    ...
    <x-slot name="header">
        <div class="flex flex-row justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Details Subscribe Informations') }}
            </h2>
        </div>
    </x-slot>
                ...
                <div class="flex flex-row gap-x-10">
                    ...
                    <div class="flex flex-col gap-y-10">    
                        ...
                        <div>
                            ...
                            <span class="bg-green-500 text-white px-3 py-2 rounded-full text-sm font-bold">SUCCESS</span>
                            @else
                            <span class="bg-yellow-500 text-white px-3 py-2 rounded-full text-sm font-bold">PENDING</span>
                            @endif
                        ...
                        <div>
                            <p class="text-slate-500 text-sm">Start Subscription Date</p>
                    ...
                    <div>
                        <img src="{{ Storage::url($subscribeTransaction->proof) }}" alt="img-proof">
                    </div>
                </div>
