            ...
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{route('admin.courses.update', $course)}}" enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        ...
                        <img src="{{Storage::url($course->thumbnail)}}" alt="thumbnail" class="rounded-2xl object-cover w-[90px] h-[90px]">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="flex flex-col gap-y-5">
                            ...
                            @forelse ($course->course_keypoints as $keypoint)
                                <input type="text" class="py-3 rounded-lg border-slate-300 border" placeholder="Write your copywriting" name="course_keypoints[]" value="{{$keypoint->name}}">
                            @empty
                                @for ($i = 0; $i < 4; $i++)
