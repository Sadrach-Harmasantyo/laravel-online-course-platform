...
<body class="text-black font-poppins pt-10 pb-[50px]">
    <div id="hero-section" style="background-image: url('{{asset('assets/background/Hero-Banner.png')}}')" class="max-w-[1200px] mx-auto w-full flex flex-col gap-10 bg-center bg-no-repeat bg-cover rounded-[32px] overflow-hidden">
