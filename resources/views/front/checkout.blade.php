    ...
    <div id="checkout-section" class="max-w-[1200px] mx-auto w-full min-h-[calc(100vh-40px)] flex flex-col gap-[30px] bg-[url('assets/background/Hero-Banner.png')] bg-center bg-no-repeat bg-cover rounded-t-[32px] overflow-hidden relative pb-6">
        ...
        <div class="flex gap-10 px-[100px] relative z-10">
            <div class="w-[400px] flex shrink-0 flex-col bg-white rounded-2xl p-5 gap-4 h-fit">
                ...
                <p class="font-semibold text-[28px] leading-[42px]">Rp {{ number_format(500000, 0, ',', '.') }}</p>
            </div>
            <form action="{{ route('front.checkout.store') }}" method="POST" class="w-full flex flex-col bg-white rounded-2xl p-5 gap-5" enctype="multipart/form-data">
                ...
                <div class="flex flex-col gap-5">
                    <div class="flex items-center justify-between">
                        ...
                        <p class="font-semibold">Sadrach Capital</p>
                        <input type="hidden" name="bankName" value="Sadrach Capital">
                    </div>
                    <div class="flex items-center justify-between">
                        <div class="flex gap-3">
                            <div class="w-6 h-6 flex shrink-0">
                        ...
                        <p class="font-semibold">8161808041</p>
                        <input type="hidden" name="accountNumber" value="8161808041">
                    </div>
                    <div class="flex items-center justify-between">
                        <div class="flex gap-3">
                            <div class="w-6 h-6 flex shrink-0">
